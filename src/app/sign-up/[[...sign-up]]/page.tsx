      ...
      <main className="flex-1 flex items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Start managing your social media like a pro</p>
          </div>
            ...
            <SignUp 
              appearance={{
                ...
                elements: {
                  ...
                  otpCodeFieldInput: "bg-slate-800 border-slate-700 text-white rounded-xl",
                  formFieldInfoText: "text-slate-500 text-sm",
                  formFieldCheckbox: "bg-slate-800 border-slate-700 rounded",
                  formFieldCheckboxLabel: "text-slate-300"
                },
                variables: {
                  colorPrimary: "#8b5cf6",
